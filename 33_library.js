...
//Creado Por Reynier Diaz Gerones(para los estudiantes)
...
(function () {
  ...
  const LibraryUI = {
    ...
    getCoverArt(title) {
      ...
      // Seleccionar color basado en el largo del título (para que sea consistente)
    ...
    getItemCard(item) {
      // Generamos la portada visual
      const coverArt = this.getCoverArt(item.title.es);
      
      // JSON seguro para el onclick
